...

{
  ...
  services.mysql = {
    ...
    initialDatabases = lib.mkDefault [{ name = "onlishop"; }];
    ensureUsers = lib.mkDefault [
      {
        name = "onlishop";
        password = "onlishop";
        ensurePermissions = {
          "onlishop.*" = "ALL PRIVILEGES";
          "onlishop_test.*" = "ALL PRIVILEGES";
        };
      }
    ];
    settings = {
  ...
  env.DATABASE_URL = lib.mkDefault "mysql://onlishop:onlishop@127.0.0.1:3306/onlishop";

  # Webpack compatibility
  env.NODE_OPTIONS = lib.mkDefault "--openssl-legacy-provider";

  # Onlishop 6 related scripts
